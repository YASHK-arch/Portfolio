...
function GitHubStarsButton({
  ...
  return (
    <motion.a
      ...
      onClick={handleClick}
      className={cn(
        "cursor-can-hover border border-slate-400/40 dark:border-slate-400/50 bg-background/20 backdrop-blur-sm !relative text-sm rounded-xl cursor-pointer whitespace-nowrap font-bold transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-[18px] shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]",
        className,
      )}
      {...props}
    >
      <div className='flex items-center gap-2 px-3.5 py-1.5 h-10 has-[>svg]:px-3.5'>
        ...
        <span className="relative inline-flex font-extrabold text-base tracking-tight">
